      ...
      >
        <div v-scroll:#scrollWrapper="onScroll">
          ...
          >
            ...
            <v-card-text class="about-text">
              <p>- проект реализован с использованием Nuxt, Vuetify, Express, Mongoose, MongoDB;</p>
              <p>- для авторизации используется JWT-токен, который сохраняется в Cookies;</p>
              <p>- время сессии 1 час;</p>
              <p>- пароль шифруется с помощью Bcrypt;</p>
              <p>- отправка сообщений осуществляется с помощью Nodemailer;</p>
              <p>- для защиты роутов применяется Passport.</p>
            </v-card-text>
          </v-card>
        </div>
      </transition>
